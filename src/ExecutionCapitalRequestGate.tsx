      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-[11px] text-inksoft mt-1.5 max-w-[620px]">
            This is separate from the ERC-8183 job payment. The controlled BSC Testnet proof requests exactly 1 U; no token approval, transfer, or trading transaction is made by this step.
          </p>
        </div>
